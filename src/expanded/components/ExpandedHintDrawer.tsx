/**
 * expanded/components/ExpandedHintDrawer.tsx
 *
 * Identical rendering logic to HintDrawer, but reads from useExpandedSolver()
 * instead of useSolver(). Safe to mount inside ExpandedSolverProvider.
 */
    ...
    <>
      {parts.map((part, i) => {
        const normalised = part
          .replace(/nnn/i, 'NNN').replace(/ppp/i, 'PPP')
