import { generateAllWorlds, applyClues } from '@shared/logic/worldSet';
import { deduceMixingResult, deduceAlchemical, deduceAspect, deduceUncertainAspect, getPossibleResults, deduceNeutralPartner, getIngredientPotionProfile, getGroupPossiblePotions, getMostInformativeMix, getGuaranteedNonProducers } from '@shared/logic/deducer';
import { COLOR_INDEX, WORLD_DATA, SIGN_TABLE, SIZE_TABLE } from '@shared/logic/worldPack';
import { validateMasterPlanAnswer, validateApprenticePlanAnswer, validateConflictOnlyAnswer } from '@base/logic/debunk';
import type {
