...
import { PotionImage, AlchemicalImage, ElemImage, SignedElemImage } from '@shared/components/GameSprites';
import type { PotionResult, AlchemicalId, Color } from '@shared/types';
