...
import { ID_RENAMES } from '@shared/utils/saveProgress';
import { type Settings, loadSettings, saveSettings } from '@shared/utils/settings';
...
function mergeSettings(a: Settings | undefined, b: Settings | undefined): Settings | undefined {
  ...
  return {
    ...
    showTimer:         a.showTimer         || b.showTimer,         // true = enabled wins
  };
}
