...
import { ALL_PUZZLES, COLLECTIONS, PUZZLE_MAP } from '@base/data/index';
import { PuzzleSolverPage } from '@base/pages/PuzzleSolverPage';
import { TutorialPage } from '@base/pages/TutorialPage';
import { MIXING_TUTORIAL_STEPS } from '@base/data/tutorials/mixing';
import { ASPECT_BALANCE_TUTORIAL_STEPS } from '@base/data/tutorials/aspect-balance';
import { SELLING_TUTORIAL_STEPS } from '@base/data/tutorials/selling';
import { TWO_COLOR_TUTORIAL_STEPS } from '@base/data/tutorials/two-color';
import { DEBUNK_APPRENTICE_TUTORIAL_STEPS } from '@base/data/tutorials/debunk-apprentice';
import { DEBUNK_MASTER_TUTORIAL_STEPS } from '@base/data/tutorials/debunk-master';
import type { TutorialId } from '@shared/contexts/TutorialContext';
import { RulesQuickReference } from '@base/components/RulesQuickReference';
import { InterfaceQuickReference } from '@base/components/InterfaceQuickReference';
import { SettingsModal } from '@shared/components/SettingsModal';
import type { Puzzle } from '@shared/types';
import { clearPuzzleState } from '@base/contexts/SolverContext';
import { ExpandedHome as ExpandedHomeImpl } from './expanded/ExpandedHome';
import { parsePermalink, hashToDisplayMap } from '@shared/utils/permalink';
import { DriveProvider, useDrive } from '@shared/contexts/DriveContext';
import { DriveSync } from '@shared/components/DriveSync';
import { shouldShowReleaseNotes, markReleaseNotesSeen, getCurrentReleaseEntry } from '@shared/utils/releaseNotes';
import { WhatsNewBanner } from '@shared/components/WhatsNewBanner';
import { loadSettings, saveSettings, type Settings } from '@shared/utils/settings';
import { clearExpandedProgress } from '@shared/utils/saveProgress';
import { BuildStamp } from '@shared/components/BuildStamp';
import { isPuzzleNonCompliant } from '@shared/compliance';
import { SaveSetupBanner } from '@shared/components/SaveSetupBanner';
