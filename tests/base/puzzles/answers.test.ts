...
import { ALL_PUZZLES } from '@base/data/index';
import { getPuzzleWorlds, computeAnswerFromWorlds } from '@base/puzzles/schema';
import { validateMasterPlanAnswer, validateApprenticePlanAnswer, validateConflictOnlyAnswer } from '@base/logic/debunk';
import type { QuestionTarget, Publication } from '@shared/types';
